...
namespace eBay_API.Controllers
{
    ...
    public sealed class OrderController : ControllerBase
    {
        ...
        public OrderController(ILogger<OrderController> logger, IOptions<Config> options, EbayService ebayService, GoogleDriveService sheetService)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> WriteOrdersToTable()
        {
            ...
            //Remove duplicates based on ItemId, keeping the one with a shipping cost value; If both have or both don't have, keep the most recent one
        ...
        /// </returns>
        [HttpPost("CreateListingsForRecentlyPurchasedItems")]
        public async Task<ActionResult<SyncOrdersResponse>> CreateListingsForRecentlyPurchasedItems([FromBody] SyncOrdersRequest req)
        {
